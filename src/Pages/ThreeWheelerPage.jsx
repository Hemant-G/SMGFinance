...
const ThreeWheelerPage = () => {
  ...
  const faqs = [
    {
      question: 'What is the maximum loan amount I can avail of for an Electric Three-Wheeler?',
      answer: 'You can avail up to Rs 1,50,000 or 75% of the total on-road vehicle price, with a minimum loan amount of Rs 30,000.',
    },
    {
      question: 'What is the interest rate on the SMG Finance Electric Three-Wheeler Loan?',
      ...
      <main className='px-4 lg:px-16'>
        ...
        <section className="py-16 bg-gray-100 px-4">
          <div className="container mx-auto ">
            <h2 className="text-4xl font-bold text-center text-blue-900 mb-12">Loan Details</h2>
