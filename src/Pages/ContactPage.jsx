  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto z-10 px-4 ">
        ...
        <p className="font-semibold text-lg">You can reach us through various channels. Choose your preferred mode of communication, and we will respond to you as quickly as possible.
        </p>
      </div>
